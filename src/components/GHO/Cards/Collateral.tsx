...
const Collateral = () => {
  return (
    ...
    >
      <g 
      // style="transform:scale(1.5) translateY(30px) translateX(-52px)"
      style={{
        transform: "scale(1.5) translateY(30px) translateX(-52px)",
      }}
      >
          ...
          >
            ...
            >
              ...
              <rect
                ...
                fill="#28D358"
                stroke="#FCFCFB"
                // style="fill:color(display-p3 0.1585 0.8276 0.3459);fill-opacity:1;stroke:color(display-p3 0.9882 0.9882 0.9843);stroke-opacity:1"
                strokeWidth="2"
              ></rect>
            </g>
          </g>
