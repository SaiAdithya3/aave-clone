  ...
  return (
    ...
    <AnimatePresence>
      ...
      >
        ...
        <g
          id="bottom"
        //   style="transform: none; // transformOrigin: 770.75px 62.5px;"
        style={{
            transform: "none",
            transformOrigin: "770.75px 62.5px",
        }}
          // transformOrigin="770.75px 62.5000114440918px"
        >
          <motion.g
        ...
        <g
          id="bottom"
        //   style="transform: none; // transformOrigin: 771.25px 187.5px;"
          style={{
            transform: "none",
        ...
        >
          <motion.g
            ...
            // style="transform: translateX(-345.117px); // transformOrigin: 771.25px 187.5px;"
            style={{
                transform: "none",
                transformOrigin: "771.25px 187.5px"
            }}
