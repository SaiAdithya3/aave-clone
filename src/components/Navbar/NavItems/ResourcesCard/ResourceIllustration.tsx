...
export const ResourceIllustration = ({
  ...
  return (
    <svg
      className="block rounded-lg w-[256px] h-[256px] overflow-hidden"
    ...
    >
      <rect
        ...
        fill={
          isActive === 0
            ? "color(display-p3 0.5951 0.587 1)"
            : isActive === 1
            ? "color(display-p3 0.121 0.5025 0.4806)"
            : isActive === 2
            ? "color(display-p3 0.949 0.2863 0)"
            : "color(display-p3 0.1098 0.2824 0.5255)"
        }
      ></rect>
      <path
        className="transition-all duration-300 ease-in-out"
        ...
        fill="#BCBBFF"
        style={{
          transform: isActive === 0 ? "none" : "translateY(-100px)",
          transformOrigin: "128px 29px",
        }}
      ></path>
      <path
      ...
      <g>
        <g
          ...
          style={{
            transform:
              isActive === 1 ? "none" : "translateX(156px) translateY(-78px)",
        ...
        >
          <g
            className="duration-300 ease-in-out transition-all"
            style={{
              transform: isActive === 1 ? "none" : "rotate(45deg)",
              transformOrigin: "240px -25.9986px",
            }}
          >
            <path
          ...
          <g
            className="duration-300 ease-in-out transition-all"
            style={{
              transform: isActive === 1 ? "none" : "rotate(-90deg)",
      ...
      <g
        ...
        style={{
          transform: isActive === 2 ? "none" : "scale(0.5) rotate(-135deg)",
      ...
      <g
        className="duration-300 ease-in-out transition-all"
        style={{
          transform: isActive === 3 ? "none" : "translateY(216px)",
      ...
      >
        <g
          className="duration-300 ease-in-out transition-all"
          style={{
            transform: isActive === 3 ? "none" : "rotate(-180deg)",
      ...
      <g
        className="duration-300 ease-in-out transition-all"
        style={{
          transform: isActive === 3 ? "none" : "translateY(192px)",
          transition:
            isActive === 3
